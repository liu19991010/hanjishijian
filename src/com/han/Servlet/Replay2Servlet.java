...
/**
 * Servlet implementation class Replay2Servlet
 */
@WebServlet("/replay2")
public class Replay2Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String connect = request.getParameter("res");
		int  comment_id = Integer.parseInt(request.getParameter("replay21"));
	    String comment_username = request.getParameter("replay22");
